...
#ifndef FLATLAND_MSGS__SRV__DETAIL__MOVE_MODEL__FUNCTIONS_H_
#define FLATLAND_MSGS__SRV__DETAIL__MOVE_MODEL__FUNCTIONS_H_
...
/// Initialize srv/MoveModel message.
/**
...
/// Finalize srv/MoveModel message.
/**
...
/// Create srv/MoveModel message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * flatland_msgs__srv__MoveModel_Request__init().
...
/// Destroy srv/MoveModel message.
/**
 * It calls
 * flatland_msgs__srv__MoveModel_Request__fini()
...
/// Check for srv/MoveModel message equality.
/**
...
/// Initialize array of srv/MoveModel messages.
/**
...
/// Finalize array of srv/MoveModel messages.
/**
 * It calls
 * flatland_msgs__srv__MoveModel_Request__fini()
...
/// Create array of srv/MoveModel messages.
/**
 * It allocates the memory for the array and calls
 * flatland_msgs__srv__MoveModel_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveModel messages.
/**
 * It calls
 * flatland_msgs__srv__MoveModel_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveModel message array equality.
/**
...
/// Copy an array of srv/MoveModel messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * flatland_msgs__srv__MoveModel_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_flatland_msgs
...
/**
 * It calls
 * flatland_msgs__srv__MoveModel_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_flatland_msgs
...
/**
 * It allocates the memory for the array and calls
 * flatland_msgs__srv__MoveModel_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_flatland_msgs
...
/**
 * It calls
 * flatland_msgs__srv__MoveModel_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FLATLAND_MSGS__SRV__DETAIL__MOVE_MODEL__FUNCTIONS_H_
