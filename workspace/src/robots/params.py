...
Kp = 2.8  # Proportional gain (higher value makes the robot follow the wall more closely, but can lead to oscillations)
Kd = 1.67 # Derivative gain (higher value makes the robot follow the wall more smoothly, but can lead to overshooting)
