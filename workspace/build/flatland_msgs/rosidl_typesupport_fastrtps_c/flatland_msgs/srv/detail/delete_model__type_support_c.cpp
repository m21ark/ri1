...
#include "flatland_msgs/srv/detail/delete_model__rosidl_typesupport_fastrtps_c.h"
...
using _DeleteModel_Request__ros_msg_type = flatland_msgs__srv__DeleteModel_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _DeleteModel_Request__ros_msg_type * ros_message = static_cast<_DeleteModel_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_flatland_msgs__srv__DeleteModel_Request(
  const void * untyped_ros_message,
...
static uint32_t _DeleteModel_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_flatland_msgs__srv__DeleteModel_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flatland_msgs
size_t max_serialized_size_flatland_msgs__srv__DeleteModel_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flatland_msgs__srv__DeleteModel_Request;
    is_plain =
      (
...
static size_t _DeleteModel_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_flatland_msgs__srv__DeleteModel_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatland_msgs, srv, DeleteModel_Request)() {
...
using _DeleteModel_Response__ros_msg_type = flatland_msgs__srv__DeleteModel_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _DeleteModel_Response__ros_msg_type * ros_message = static_cast<_DeleteModel_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flatland_msgs
size_t get_serialized_size_flatland_msgs__srv__DeleteModel_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DeleteModel_Response__ros_msg_type * ros_message = static_cast<const _DeleteModel_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_flatland_msgs__srv__DeleteModel_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flatland_msgs
size_t max_serialized_size_flatland_msgs__srv__DeleteModel_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = flatland_msgs__srv__DeleteModel_Response;
    is_plain =
      (
...
static size_t _DeleteModel_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_flatland_msgs__srv__DeleteModel_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatland_msgs, srv, DeleteModel_Response)() {
...
// already included above
// #include "flatland_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "flatland_msgs/srv/delete_model.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatland_msgs, srv, DeleteModel)() {
