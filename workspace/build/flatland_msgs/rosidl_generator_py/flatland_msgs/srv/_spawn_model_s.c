...
bool flatland_msgs__srv__spawn_model__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flatland_msgs.srv._spawn_model.SpawnModel_Request", full_classname_dest, 49) == 0);
  }
  flatland_msgs__srv__SpawnModel_Request * ros_message = _ros_message;
  {  // yaml_path
...
PyObject * flatland_msgs__srv__spawn_model__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("flatland_msgs.srv._spawn_model");
...
ROSIDL_GENERATOR_C_EXPORT
bool flatland_msgs__srv__spawn_model__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flatland_msgs.srv._spawn_model.SpawnModel_Response", full_classname_dest, 50) == 0);
  }
  flatland_msgs__srv__SpawnModel_Response * ros_message = _ros_message;
  {  // success
