...
class Metaclass_SpawnModel(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from flatland_msgs.srv import _spawn_model
...
class SpawnModel(metaclass=Metaclass_SpawnModel):
    from flatland_msgs.srv._spawn_model import SpawnModel_Request as Request
    from flatland_msgs.srv._spawn_model import SpawnModel_Response as Response
