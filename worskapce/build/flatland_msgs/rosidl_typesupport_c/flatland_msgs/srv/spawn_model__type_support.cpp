...
static const _SpawnModel_Request_type_support_symbol_names_t _SpawnModel_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatland_msgs, srv, SpawnModel_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatland_msgs, srv, SpawnModel_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flatland_msgs, srv, SpawnModel_Request)() {
  return &::flatland_msgs::srv::rosidl_typesupport_c::SpawnModel_Request_message_type_support_handle;
}
...
static const _SpawnModel_Response_type_support_symbol_names_t _SpawnModel_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatland_msgs, srv, SpawnModel_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatland_msgs, srv, SpawnModel_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flatland_msgs, srv, SpawnModel_Response)() {
  return &::flatland_msgs::srv::rosidl_typesupport_c::SpawnModel_Response_message_type_support_handle;
}
...
static const _SpawnModel_type_support_symbol_names_t _SpawnModel_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatland_msgs, srv, SpawnModel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatland_msgs, srv, SpawnModel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, flatland_msgs, srv, SpawnModel)() {
  return &::flatland_msgs::srv::rosidl_typesupport_c::SpawnModel_service_type_support_handle;
}
