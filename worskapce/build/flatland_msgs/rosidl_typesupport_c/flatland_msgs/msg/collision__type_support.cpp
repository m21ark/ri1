...
static const _Collision_type_support_symbol_names_t _Collision_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatland_msgs, msg, Collision)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatland_msgs, msg, Collision)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flatland_msgs, msg, Collision)() {
  return &::flatland_msgs::msg::rosidl_typesupport_c::Collision_message_type_support_handle;
}
