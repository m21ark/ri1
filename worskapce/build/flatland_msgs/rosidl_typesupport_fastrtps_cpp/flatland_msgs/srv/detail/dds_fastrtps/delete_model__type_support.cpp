...
#include "flatland_msgs/srv/detail/delete_model__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flatland_msgs::srv::DeleteModel_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const flatland_msgs::srv::DeleteModel_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flatland_msgs::srv::DeleteModel_Request *>(
    untyped_ros_message);
...
{
  return &flatland_msgs::srv::typesupport_fastrtps_cpp::_DeleteModel_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = flatland_msgs::srv::DeleteModel_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const flatland_msgs::srv::DeleteModel_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<flatland_msgs::srv::DeleteModel_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &flatland_msgs::srv::typesupport_fastrtps_cpp::_DeleteModel_Response__handle;
}
...
{
  return &flatland_msgs::srv::typesupport_fastrtps_cpp::_DeleteModel__handle;
}
