...
static const _DebugTopicList_type_support_symbol_names_t _DebugTopicList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flatland_msgs, msg, DebugTopicList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, flatland_msgs, msg, DebugTopicList)),
  }
};
...
{
  return &::flatland_msgs::msg::rosidl_typesupport_cpp::DebugTopicList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, flatland_msgs, msg, DebugTopicList)() {
  return get_message_type_support_handle<flatland_msgs::msg::DebugTopicList>();
}
