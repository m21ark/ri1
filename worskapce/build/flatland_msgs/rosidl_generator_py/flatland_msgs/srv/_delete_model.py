...
class Metaclass_DeleteModel(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from flatland_msgs.srv import _delete_model
...
class DeleteModel(metaclass=Metaclass_DeleteModel):
    from flatland_msgs.srv._delete_model import DeleteModel_Request as Request
    from flatland_msgs.srv._delete_model import DeleteModel_Response as Response
